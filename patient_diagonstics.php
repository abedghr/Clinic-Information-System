...
<head>
	...
	<title>Patients Diagonstics</title>
					...
					<div class="col-md-10 col-md-offset-1 contact-form">
						...
						<?php 
							...
							while($row = mysqli_fetch_assoc($re)){
								$pat_id = $row['id'];
								$query = "SELECT diagnostics.* , doctors.doc_name from diagnostics INNER JOIN doctors on diagnostics.doctor_id = doctors.id where diagnostics.patient_id = $pat_id";
								if($res = mysqli_query($conn , $query)){
									while($roww = mysqli_fetch_assoc($res)){
										echo '<div class="col-md-12 col-md-offset-1 contact-form" style="border-bottom:2px solid white; margin-bottom:8px;">';
										...
										echo '<h4 style="color:white; font-size:23px;"><strong>Diagonstic:</strong></h4>';
										echo '<p style="color:white;">'.$roww['diagnostics'].'</p>';
										echo '</div>';
